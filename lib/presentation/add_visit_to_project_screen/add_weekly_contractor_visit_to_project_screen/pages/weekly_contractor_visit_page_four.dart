...
class WeeklyContractorVisitPageFour extends StatefulWidget {
  const WeeklyContractorVisitPageFour({Key? key}) : super(key: key);

  @override
  _WeeklyContractorVisitPageFourState createState() =>
      _WeeklyContractorVisitPageFourState();
}

class _WeeklyContractorVisitPageFourState
    extends State<WeeklyContractorVisitPageFour> {
