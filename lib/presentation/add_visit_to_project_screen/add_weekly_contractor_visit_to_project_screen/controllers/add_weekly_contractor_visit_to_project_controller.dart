...
class AddWeeklyContractorVisitToProjectController extends GetxController {
  ...
  TextEditingController workersSafetyComment = TextEditingController();
  TextEditingController siteSafetyComment = TextEditingController();

  //3
  TextEditingController projectManagementManagerValue = TextEditingController();
  TextEditingController directorOfTechnicalAffairsValue = TextEditingController();
...
// اكمل باقي الصفحات بنفس الطريقة
  ...
  bool isThirdPageDataComplete() {
    ...
    if (projectManagementManagerValue.text == '' || directorOfTechnicalAffairsValue.text == '') {
      return false;
    }
