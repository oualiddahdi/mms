...
class _DatePickerDialogState extends State<HijriDatePickerDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    // Set the locale for Hijri formatting based on the current context
    HijriCalendar.setLocal(currentLocale.languageCode);
...
class _DatePickerHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Brightness brightness = ThemeData.estimateBrightnessForColor(themeData.primaryColor);
      ...
      if (day < 1) {
        ...
        if (isSelectedDay) {
          ...
          itemStyle = themeData.textTheme.bodyText2
              ?.copyWith(color: themeData.colorScheme.onSurface.withOpacity(0.38));
        ...
        Widget dayWidget = Container(
          ...
          child: Center(
            child: Semantics(
              ...
              // formatted full date.
              label: '${localizations.formatDecimal(day)}, ${dayToBuild.toString()}',
