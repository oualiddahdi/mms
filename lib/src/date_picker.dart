      ...
      child: OverflowBar(
        ...
        children: <Widget>[
          TextButton(
            ...
            child: Text(localizations.cancelButtonLabel ,style: TextStyle(fontSize: 14, color: Colors.black),),
          ),
          TextButton(
            onPressed: _handleOk,
            child: Text( localizations.okButtonLabel,style: TextStyle(fontSize: 14, color: Colors.black),),
          ),
        ],
      ),
    );
